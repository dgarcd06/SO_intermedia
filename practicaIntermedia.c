...
int main(int argc, char *argv[])
{
    ...
    if(farmaceutico == 0){
        ...
        printf("Soy el farmaceutico con PID = %d",getpid());
        ...
        printf("Soy el epidemiologo con PID = %d",getpid());
        sleep(2);
        kill(farmaceutico,SIGUSR1);
    ...
    printf("Se han vacunado %d pacientes, y en %d la vacuna ha sido efectiva",numHijos,vacunados);
